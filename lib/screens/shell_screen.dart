...
class _ShellScreenState extends State<ShellScreen> {
  ...
  ///
  /// Chiuso di default, e non aperto: ogni schermata monta i propri
  /// Timer.periodic da 2-3 secondi e ogni chiamata Ekos e' un sottoprocesso
  /// qdbus6 sul Raspberry, quindi due pannelli sono il doppio del carico.
  /// Chi lo vuole lo apre; nessuno se lo ritrova addosso.
  bool _twoPaneEnabled = false;
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      ...
      return Scaffold(
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Column(children: [
                ...
                // Avvisi spinti dal bridge (programmi esterni via UDP).
        ...
        // "Sempre" va preso alla lettera: il pulsante per riaprire il secondo
        // pannello si aggiunge sopra, non lo sostituisce. E' l'unico comando
        // dell'app che non puo' sparire, a nessuna larghezza di finestra.
        floatingActionButton: Column(
          mainAxisSize: MainAxisSize.min,
          crossAxisAlignment: CrossAxisAlignment.end,
          children: [
            if (canSplit && !_twoPaneEnabled) ...[
              _ReopenSplitFab(
                  onPressed: () => setState(() => _twoPaneEnabled = true)),
